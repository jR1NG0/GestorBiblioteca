...
use GestorBiblioteca\Http\Requests\PeliculaRequest; // request personalizado creado para la validacion de datos del formulario
//uso de modelos
use GestorBiblioteca\Pelicula;   
...
{   
     ...
     *Revisar GestorBiblioteca\Http\Requests\PeliculaRequest.php*/
